    ...
    return (
        <div className="flex items-center bg-black m-2 justify-between">
            <ul className="text-white flex-1 flex">
                ...
                <NavLink className={'hover:bg-gray-700 p-4 text-center w-[10vw] duration-300 border-b-2 border-transparent hover:border-b-red-400'} to={'/countries'}>Countries</NavLink>
