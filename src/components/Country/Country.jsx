...
const Country = () => {
    ...
    return (
        <div className="w-4/5 grid grid-cols-1 gap-4 p-4 mx-auto md:grid-cols-2 lg:grid-cols-3">
            {
                countries.map((country, idx) => <div className="text-center shadow-xl space-y-4 border border-blue-500" key={idx}>
